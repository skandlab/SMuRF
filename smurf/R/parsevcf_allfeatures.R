...
#' 
#' @export
parsevcf_allfeatures = function(x){
  ...
  svp_m<-ScanVcfParam(info=c("BaseQRankSum","ClippingRankSum","FS","MQ","MQRankSum","NLOD","ReadPosRankSum","TLOD"), samples=scanVcfHeader(x[[1]])@samples, geno=c("AD", "AF", "DP"))
