...
parsevcf_raw = function(x){
  ...
  svp_m<-ScanVcfParam(info=c("MQ0"), samples=scanVcfHeader(x[[1]])@samples, geno=c("AD", "DP"))
  svp_f<-ScanVcfParam(info=c("MQM"),samples=scanVcfHeader(x[[2]])@samples, geno=c("RO","DP"))
  svp_vs<-ScanVcfParam(info=c("SSC"), samples=scanVcfHeader(x[[3]])@samples, geno=c("AD","FREQ", "DP"))
  svp_vd<-ScanVcfParam(info=c("MSI"), samples=scanVcfHeader(x[[4]])@samples, geno=c("AD", "AF", "DP"))
